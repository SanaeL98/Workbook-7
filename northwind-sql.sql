...
-- The table that holds the types (categories) of the items is: Categories
...
-- Question 9: Show all rows and columns from the Categories table
...
-- Question 10: List all products in the Seafood category (CategoryID = 8)
...
-- Question 14: Employees with salary between $2000 and $2500
